...
df[to_num] = df[to_num].apply(pd.to_numeric, errors='coerce').round(3)
...
dataset_covered = df.groupby("Dataset Name")["No. Covered Data Points"].first()
...
heat.set_ylabel("Number of Covered Data Points Range", fontsize=14)
heat.set_title("Impact of Covered Data Points on Rank Correlation",
               fontsize=16, pad=12)
