...
# # Load metadata file
# file_location = os.path.join(os.path.dirname(__file__), 'metadata_metrics_DimRed.csv')
...
#     # Assigning 'Shape' value based on a predefined list
#     shape = "['cluster' 'three_order' 'lip_cluster' 'linear']"
