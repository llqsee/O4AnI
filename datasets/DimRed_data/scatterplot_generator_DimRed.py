...
figure_folder_name = os.getcwd() + '/datasets/DimRed_data/Data_GlimmerMDS_figures_files_fu'
# figure_folder_name = os.getcwd() + '/datasets/DimRed_data/Data_TSNE_figures_files_fu'
# figure_folder_name = os.getcwd() + '/datasets/DimRed_data/Data_PCA_figures_files'
...
# Load data
data_folder = os.path.join(os.getcwd(), 'datasets/DimRed_data/Data_GlimmerMDS/fu')
# data_folder = os.path.join(os.getcwd(), 'datasets/DimRed_data/Data_TSNE')
# data_folder = os.path.join(os.getcwd(), 'datasets/DimRed_data/Data_PCA')
...
metadata_save_folder = os.getcwd() + '/datasets/DimRed_data/'

# Define the name of the metadata file
metadata_csv = "metadata_metrics_DimRed_fu_2.csv"
