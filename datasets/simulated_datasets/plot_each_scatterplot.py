...
# Define folder paths
data_folder = os.path.join(os.getcwd(), 'datasets/DimRed_data/Data_GlimmerMDS')
output_folder = os.path.join(os.getcwd(), 'datasets/DimRed_data/example_scatterplots_GlimmerMDS')
...
summary_file = os.path.join(output_folder, 'seperation_label_Data_GlimmerMDS.csv')
