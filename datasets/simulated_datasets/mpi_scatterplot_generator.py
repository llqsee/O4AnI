...
def main():
    ...
    parser.add_argument('--data-folder', type=str,
                        default=os.getcwd() + '/datasets/simulated_datasets/csv_files_1')
    parser.add_argument('--figure-folder', type=str,
                        default=os.getcwd() + '/datasets/simulated_datasets/figure_files_0623_evening')
    parser.add_argument('--metadata-csv-path', type=str,
                        default=os.getcwd() + '/datasets/simulated_datasets/metadata_metrics_simulated_0623_evening.csv')
