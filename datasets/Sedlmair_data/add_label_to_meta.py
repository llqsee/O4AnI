...
# 1. Load both CSVs
cluster_df = pd.read_csv("datasets/Sedlmair_data/LabelInformation.csv")
scatter_df = pd.read_csv("datasets/Sedlmair_data/metadata_metrics_sedlmair_0623_afternoon.csv")
...
scatter_df.to_csv(
    "datasets/Sedlmair_data/merged_scatter_with_shape_and_correlation.csv",
    index=False
)
print("Done – saved to datasets/Sedlmair_data/merged_scatter_with_shape_and_correlation.csv")
