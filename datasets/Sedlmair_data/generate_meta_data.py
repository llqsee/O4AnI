...
marker_size = [10, 60, 100, 150]

# Define the folder for saving the generated scatterplots
figure_folder_name = os.getcwd() + '/datasets/Sedlmair_data/generated_scatterplots_different_marker_sizes'
...
# Load data
data_folder = os.path.join(os.getcwd(), 'datasets/Sedlmair_data/DR_data')

# csv_files = [f for f in os.listdir(data_folder) if f.endswith('.csv')]

example_data_folder = os.path.join(os.getcwd(), 'datasets/Sedlmair_data/selected_dataset')
selected_csv_files = [f for f in os.listdir(example_data_folder) if f.endswith('.png')]
csv_files = [f.replace('.png', '.csv') for f in selected_csv_files]




# Define the folder for saving the metadata
metadata_save_folder = os.getcwd() + '/datasets/Sedlmair_data/'

# Define the name of the metadata file
metadata_csv = "metadata_metrics_Sedlmair.csv"
