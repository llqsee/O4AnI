...
# ———————————————— 
base_dir = "datasets/Sedlmair_data"
csv_folder_name = 'DR_data'
scatterplot_folder_name = 'figure_files_0623_afternoon'

cluster_df = pd.read_csv(
    os.path.join(base_dir, "LabelInformation.csv")
)
...
for _, row in cluster_df.iterrows():
    ...
    for ext in EXTS:
        pattern = os.path.join(base_dir, scatterplot_folder_name, f"*{base}*.{ext}")
