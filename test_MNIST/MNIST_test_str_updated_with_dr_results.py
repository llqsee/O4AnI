...
file_location = 'datasets/mnist/mnist_pred_updated_str_with_dr_results.csv'
...
analysis.importance_metric(important_cal_method = 'mahalanobis_distance', weight_diff_class=10, weight_same_class=0, order_variable='importance_index', asending=True)
