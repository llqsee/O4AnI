...
file_location = 'datasets/simulated_datasets/csv_files_1/clusternumber3_datanumber100_testnumbercategorylarge_repeatnumber2.csv'
...
for rm in render_order_methods:
    for mk in marker_sizes:
        ...
        analysis.save_figure(filename = f'test_simulated_data/figure_{rm}markersize{mk}_clusternumber3_datanumber200_testnumbercategorysmall_repeatnumber1.png')
        analysis.save_heatmap(filename = f'test_simulated_data/figure_{rm}markersize{mk}_clusternumber3_datanumber200_testnumbercategorysmall_repeatnumber1_heatmap.png')
        ...
        analysis.plot_scatter_with_importance(filename = 'test_simulated_data/scatterplot_with_importance_simulated_data.png', grid=True, x_grid=50, y_grid=60)